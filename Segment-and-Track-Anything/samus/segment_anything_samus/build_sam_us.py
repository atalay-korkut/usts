...
def build_samus_vit_b():
    return _build_samus(
        encoder_embed_dim=768,
        encoder_depth=12,
        encoder_num_heads=12,
        encoder_global_attn_indexes=[2, 5, 8, 11],
        #  checkpoint='./samus/segment_anything_samus/checkpoints/SAMUS__399.pth'  # Hardcoded path
      # checkpoint= 'ckpt/sam_vit_b_01ec64.pth'
     checkpoint= '/home/aorta-scan/Atalay/Segment-and-Track-Anything/samus/segment_anything_samus/checkpoints/SAMUS__199.pth'
    )
...
def _build_samus(
    ...
    checkpoint='/home/aorta-scan/Atalay/Segment-and-Track-Anything/samus/segment_anything_samus/checkpoints/SAMUS__199.pth',  # Hardcoded value
