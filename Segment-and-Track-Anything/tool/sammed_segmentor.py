...
from sammed import predictor_sammed
from sammed import build_sam
...
class Segmentor:
    def __init__(self, sam_args):
        ...
        self.sam = build_sam(sam_args)
        self.sam.to(device=self.device)
        self.everything_generator = SamAutomaticMaskGenerator(model=self.sam, **sam_args['generator_args'])
        
        self.interactive_predictor = predictor_sammed.SammedPredictor(sam_model_registry[sam_args["model_type"]](checkpoint=sam_args["sam_checkpoint"]))
