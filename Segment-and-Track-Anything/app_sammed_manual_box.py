...
from sam.segment_anything import build_sam_vit_b
...
def sam_bbox_manual(Seg_Tracker, origin_frame, bbox_coordinates_input, aot_model, long_term_mem, max_len_long_term, sam_gap, max_obj_num, points_per_side):
    ...
    Args:
        origin_frame: nd.array
        bbox_coordinates_input: str, format: "x1,y1;x2,y2"
    """
    print("Manual Bounding Box")
...
def sam_click_manual(Seg_Tracker, origin_frame, click_stack, coordinates_input, aot_model, long_term_mem, max_len_long_term, sam_gap, max_obj_num, points_per_side):
    ...
    Args:
        origin_frame: nd.array
        click_stack: [[coordinate], [point_mode]]
        coordinates_input: str, format: "x1,y1,mode1;x2,y2,mode2"
    """
    print("Manual Click")
    ...
    # Refine according to the parsed coordinates
    prompt = {
        "points_coord": click_stack[0],
        "points_mode": click_stack[1],
        "multimask": "True",
...
def seg_track_app():
        ...
        with gr.Row():
            ...
            with gr.Column(scale=0.5):
                ...
                with tab_click:
                    ...
                    with gr.Row():
                        coordinates_input = gr.Textbox(label="Input Coordinates", placeholder="x1,y1,mode1;x2,y2,mode2")
                        submit_coordinates = gr.Button(value="Submit Coordinates")
                ...
                with tab_stroke:
                    ...
                    with gr.Row():
                        bbox_coordinates_input = gr.Textbox(label="Input Bounding Box Coordinates", placeholder="x1,y1;x2,y2")
                        submit_bbox_coordinates = gr.Button(value="Submit Bounding Box Coordinates")
    ...
    ##########################################################
        ...
        submit_coordinates.click(
            fn=sam_click_manual,
            inputs=[
                Seg_Tracker, origin_frame, click_stack, coordinates_input,
                aot_model,
                long_term_mem,
                max_len_long_term,
                sam_gap,
        ...
        submit_bbox_coordinates.click(
            fn=sam_bbox_manual,
            inputs=[
                Seg_Tracker, origin_frame, bbox_coordinates_input,
