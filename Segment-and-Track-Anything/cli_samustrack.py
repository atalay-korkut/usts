...
def cli_samustrack(input_video=None, input_img_seq=None, aot_model="r50_deaotl", long_term_mem=9999, max_len_long_term=9999, sam_gap=100, max_obj_num=255, points_per_side=16, point_mode="Positive", coordinates_input=None, bbox_coordinates_input=None, drawing_board=None, fps=8):
    Seg_Tracker = None
    origin_frame = None
    click_stack = [[], []]
...
if __name__ == "__main__":
    output_video, output_mask = cli_samustrack(
